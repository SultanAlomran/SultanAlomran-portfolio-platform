...
public sealed class PortfolioDbContext(DbContextOptions<PortfolioDbContext> options) : DbContext(options), IPortfolioDbContext
{
    ...
    public DbSet<PopularSearch> PopularSearchs => Set<PopularSearch>();
    public DbSet<Profile> Profiles => Set<Profile>();
    public DbSet<Project> Projects => Set<Project>();
    public DbSet<ProjectImage> ProjectImages => Set<ProjectImage>();
    public DbSet<ProjectLink> ProjectLinks => Set<ProjectLink>();
    public DbSet<ProjectTechnology> ProjectTechnologys => Set<ProjectTechnology>();
    ...
    public DbSet<Series> Seriess => Set<Series>();
    public DbSet<SeriesItem> SeriesItems => Set<SeriesItem>();
    public DbSet<Session> Sessions => Set<Session>();
    public DbSet<SiteSetting> SiteSettings => Set<SiteSetting>();
    public DbSet<Skill> Skills => Set<Skill>();
    public DbSet<SkillCategory> SkillCategorys => Set<SkillCategory>();
